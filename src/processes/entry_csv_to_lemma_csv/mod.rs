            ...
            for row in rows {
                ...
                match part_of_speech {
                    "Verb" => {
                        ...
                        writer.write(format!("{}|{}\n", verb.lemma.unaccented(), verb.lemma).as_bytes()).expect("writing success");
                    },
                    "Noun" => {
                        ...
                        if let Some(form) = noun.dat_sing { writer.write(format!("{}|{}\n", form.unaccented(), noun.lemma).as_bytes()).expect("writing success"); };
                        if let Some(form) = noun.dat_plur { writer.write(format!("{}|{}\n", form.unaccented(), noun.lemma).as_bytes()).expect("writing success"); };
                    ...
                    "Adverb" => {
                        let adv: rubit_api_db::dictionary_info::russian::RussianAdverb = serde_json::from_str(dictionary_info).expect("success of deserialization");
                        writer.write(format!("{}|{}\n", adv.lemma.unaccented(), adv.lemma).as_bytes()).expect("writing success");
                    },
            ...
            for row in rows {
                ...
                match part_of_speech {
                    "Verb" => {
                        ...
                        if let Some(form) = verb.present_passive { writer.write(format!("{}|{}\n", form.unaccented(), verb.lemma).as_bytes()).expect("writing success"); };
                        if let Some(form) = verb.present_adverbial { writer.write(format!("{}|{}\n", form.unaccented(), verb.lemma).as_bytes()).expect("writing success"); };
                        if let Some(form) = verb.present_active { writer.write(format!("{}|{}\n", form.unaccented(), verb.lemma).as_bytes()).expect("writing success"); };
                        
                        if let Some(form) = verb.ти_imperative { writer.write(format!("{}|{}\n", form.unaccented(), verb.lemma).as_bytes()).expect("writing success"); };
                        if let Some(form) = verb.ви_imperative { writer.write(format!("{}|{}\n", form.unaccented(), verb.lemma).as_bytes()).expect("writing success"); };
                        if let Some(form) = verb.ми_imperative { writer.write(format!("{}|{}\n", form.unaccented(), verb.lemma).as_bytes()).expect("writing success"); };
                    },
                    "Noun" => {
